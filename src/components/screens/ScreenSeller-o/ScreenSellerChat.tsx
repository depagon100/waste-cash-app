...
interface Props {
  ...
  route: RouteProp<SellerStackParam, 'SellerChat'>;
  socket: Socket;
}

export const ScreenSellerChat: React.FC<Props> = ({
  conversationData,
  me,
  isLoading,
  ...
  }, [conversationData, message, recipient, socket, onSendMessage, setMessage]);
  ...
  React.useEffect(() => {
    onGetConversationData(conversationId);
  }, [conversationId, onGetConversationData]);
